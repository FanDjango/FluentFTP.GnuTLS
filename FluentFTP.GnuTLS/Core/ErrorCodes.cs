...
namespace FluentFTP.GnuTLS.Core {
	internal static class EC {
		...
		/// <summary>
		/// Dictionary mapping error code values to their string names.
		/// Automatically generated from the enum to ensure consistency.
		/// </summary>
		public static readonly Dictionary<int, string> ec = CreateEc();
